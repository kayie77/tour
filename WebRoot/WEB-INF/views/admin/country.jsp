  ...
  <body>
		    ...
		    <div class="modal fade" id="addOrEditDialog" tabindex="-1" role="dialog" aria-labelledby="分类编辑" data-backdrop="static">
 			...
 			<small style="float:right">
  			...
  			<form class="form-inline" action="/tour/country/revealObject" method="get">
            ...
            <table class="table table-striped">
              ...
              <c:forEach var="country" items="${countryList}">
		       <tr id="${country.c_id}">
		       <td><input type="checkbox" class="js-row_selector">${country.c_id }</td>
    ...
    $(document).ready(function () {
	    $('button[name="newEntity"]').click(function (){
	         var url = '/tour/country/view/new';
   	         showModal(url);
	    });
	    
	    $('button[name="editEntity"]').click(function (){
	    	var id = $(this).parents('tr').attr('id');
	         var url = '/tour/country/view/edit?id='+id;
   	         showModal(url);
	    });
          ...
          if (!ids || ids.length <= 0) {
            ...
            bootbox.confirm('此操作将会级联删除其关联的所有数据，确定要删除吗?',function(result){
              if(result) { 
                ...
                var url = '/tour/country/del?' + params;
