   ...
   <body>
	<div class="modal-content">
	  <div class="modal-header">
	    ...
	    <h4 class="modal-title" id="myModalLabel">景点分类新增/编辑</h4>
	  </div>
	  <div class="modal-body">
	    ...
	    <form id="objectForm" class="form-horizontal" method="post">
	      <div class="form-group">
	        ...
	        <input type="hidden" name="sc_id" value="${scenicClass.sc_id}"/>
	        <label for="sc_name" class="col-sm-3 control-label"><span style="color:red;"> * </span>景点分类名称</label>
	        <div class="col-sm-3">
	          <input type="text" class="form-control" id="sc_name" name="sc_name" value="${scenicClass.sc_name}">
	        </div>
	      </div>    
	    </form>
	  </div>
	...
	<script>
 	 ...
 	 function objectSubmit(){  
 	 	var url= null;
		if(${type}==1){//代表新增
			url = "/tour/scenicClass/new";
		}else{
			url = "/tour/scenicClass/edit";
		}
     	$.ajax({
		  type: "post",
		  url: url,
