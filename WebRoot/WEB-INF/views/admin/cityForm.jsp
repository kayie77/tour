   ...
   <body>
	<div class="modal-content">
	  <div class="modal-header">
	    ...
	    <h4 class="modal-title" id="myModalLabel">城市新增/编辑</h4>
	  </div>
	  <div class="modal-body">
	    ...
	    <form id="objectForm" class="form-horizontal" method="post">
	      <div class="form-group">
	        ...
	        <label for="ct_name" class="col-sm-2 control-label"><span style="color:red;"> * </span>省会分类</label>
	        <div class="col-sm-3">
	      ...
	      <div class="form-group">
	        ...
	        <label for="ct_name" class="col-sm-2 control-label"><span style="color:red;"> * </span>城市名称</label>
	        <div class="col-sm-3">
