  ...
  <body>
		    ...
		    <div class="modal fade" id="addOrEditDialog" tabindex="-1" role="dialog" aria-labelledby="分类编辑" data-backdrop="static">
 			...
 			<small style="float:right">
  			...
  			<form class="form-inline" action="/tour/city/revealObject" method="get">
			  <div class="form-group">
			    <label for="classword">省会分类</label>
            ...
            <table class="table table-striped ">
              ...
              <c:forEach var="city" items="${cityList}">
		       <tr id="${city.ct_id}">
		       <td><input type="checkbox" class="js-row_selector">${city.ct_id }</td>
		       <td>${city.province.country.c_name}</td>
		       <td>${city.province.p_name }</td>
		       <td>${city.ct_name }</td>
			   <td>
    ...
    $(document).ready(function () {
	    $('button[name="newEntity"]').click(function (){
	         var url = '/tour/city/view/new';
   	         showModal(url);
	    });
	    
	    $('button[name="editEntity"]').click(function (){
	    	var id = $(this).parents('tr').attr('id');
	         var url = '/tour/city/view/edit?id='+id;
   	         showModal(url);
	    });
