...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="#">路线</a>
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <!-- main_top -->
            <div class="main_top">
              <div class="top_left pull-left "><img class="img-thumbnail" src="${line.imageUrl }" ></div>
              <div class="top_right">
                <h2><b>${line.l_name }</b></h2>
                <span class="price">价格： ¥ ${line.price }</span>
              </div>
            </div>

            <div class="detail-sub-title"><i></i>路线介绍</div>
            ...
            <div class="imgPanel">
              <img class="" src="${line.bgUrl }" alt="Generic placeholder image" >
            </div>
            <div class="commit">
              <button class="btn btn-success" style="width:200px;" onClick="ajaxSubmit(${line.l_id});">立即预订</button>
            </div>
